...
export const crearEstado = async (req, res) => {
    ...
    try {
        ...
        const existingEstado = await prisma.estadoParafraseo.findFirst({
            where: {
        ...
        // Crear la servicio
        const nuevoEstado = await prisma.estadoParafraseo.create({
            data: {
                estado: nombre_estado,
...
export const listarEstados = async (req, res) => {
    try {
        const estados = await prisma.estadoParafraseo.findMany();
...
export const actualizarEstado = async (req, res) => {
    ...
    const data = req.body;
    try {
        const updatedEstado = await prisma.estadoParafraseo.update({
            where: {
                id: Number(id),
            },
            data: {
...
export const eliminarEstado = async (req, res) => {
    const { id } = req.params;
    try {
        const findEstado = await prisma.estadoParafraseo.findUnique({
            where: {
                id: Number(id),
            },
        });
        ...
        await prisma.estadoParafraseo.delete({
            where: {
                id: Number(id),
            },
        });
