...
export const crearEstado = async (req, res) => {
    ...
    try {
        ...
        const existingEstado = await prisma.estadoTrabajoSuficiencia.findFirst({
            where: {
        ...
        // Crear la servicio
        const nuevoEstado = await prisma.estadoTrabajoSuficiencia.create({
            data: {
                estado: nombre_estado,
...
export const listarEstados = async (req, res) => {
    try {
        const estados = await prisma.estadoTrabajoSuficiencia.findMany();
...
export const actualizarEstado = async (req, res) => {
    ...
    const data = req.body;
    try {
        const updatedEstado = await prisma.estadoTrabajoSuficiencia.update({
            where: {
                id: Number(id),
            },
            data: {
...
export const eliminarEstado = async (req, res) => {
    const { id } = req.params;
    try {
        const findEstado = await prisma.estadoTrabajoSuficiencia.findUnique({
            where: {
                id: Number(id),
            },
        });
        ...
        await prisma.estadoTrabajoSuficiencia.delete({
            where: {
                id: Number(id),
            },
        });
